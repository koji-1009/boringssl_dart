...
/// Generate lib/src/version.g.dart from native/boringssl_commit.txt so the
/// pinned commit is exposed as a compile-time constant.
Future<void> generateVersion() async {
  ...
  final buffer = StringBuffer()
    ..writeln('// Auto-generated by ffigen.dart. Do not edit.')
    ..writeln(
    ...
    ..writeln('/// the crypto implementation.')
    ..writeln("const String boringsslCommit = '$commit';");

  await File('lib/src/version.g.dart').writeAsString(buffer.toString());
  print('Generated lib/src/version.g.dart for commit $commit');
}
